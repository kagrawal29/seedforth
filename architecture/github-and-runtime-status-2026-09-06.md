...
|---|---|---|---|
| `kagraw29/seedforth` | current `main` | current `main` | local platform main matches GitHub main; live runtime is pinned to tested `3dff1e6` (verify SHA with the reconciler) |
...
- `/opt/seedforth/current` points to immutable release `3dff1e6`; the
